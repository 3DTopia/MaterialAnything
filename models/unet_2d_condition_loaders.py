...
class UNet2DConditionLoadersMixin:
    ...
    def _convert_ip_adapter_attn_to_diffusers(self, state_dicts, low_cpu_mem_usage=False):
        ...
        for name in self.attn_processors.keys():
            ...
            elif name.startswith("up_blocks_outer"):
                hidden_size = list(reversed(self.config.block_out_channels))[-1]
            elif name.startswith("down_blocks_outer"):
                hidden_size = self.config.block_out_channels[0]
