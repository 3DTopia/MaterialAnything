...
from diffusers.utils import MIN_PEFT_VERSION, check_peft_version, is_peft_available
...
class PeftAdapterMixin:
    ...
    def add_adapter(self, adapter_config, adapter_name: str = "default") -> None:
        ...
        inject_adapter_in_model(adapter_config, self.down_blocks, adapter_name)
        inject_adapter_in_model(adapter_config, self.mid_block, adapter_name)
        inject_adapter_in_model(adapter_config, self.up_blocks, adapter_name)
        self.peft_config = self.down_blocks.peft_config
